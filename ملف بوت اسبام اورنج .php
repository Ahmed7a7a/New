...
في بوت سبام اورنج الافضل

يمكنك عمل اسبام علي ارقام اورنج
...
'chat_id'=>$chat_id,
'text'=>"
*حدث خطاء ما يرجا محاوله في وقت لحق*
",
        'parse_mode'=>"markdown",
                'reply_to_message_id'=>$message->message_id,
        'disable_web_page_preview'=>true,
...
for($i=0; $i<1; $i++){
$api = json_decode(file_get_contents("https://z63k.tk/API/spam/orange-sms.php?number=$text"),1);
}
}
}
}